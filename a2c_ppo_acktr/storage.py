...
class RolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_shape, action_space,
        ...
        self.value_mixed = torch.zeros(num_steps + 1, num_processes, 1)
    ...
    def to(self, device):
        ...
        self.value_mixed = self.value_mixed.to(device)
        self.beta_v = self.beta_v.to(device)

    def insert(self, obs, recurrent_hidden_states, actions, action_log_probs,
               value_preds, rewards, masks, bad_masks,value_mixed,beta_v):
        ...
        self.value_mixed[self.step + 1].copy_(value_mixed)
    ...
    def after_update(self):
        ...
        self.value_mixed[0].copy_(self.value_mixed[-1])
            ...
            if use_gae:
                ...
                for step in range(self.rewards.size(0)):
                    ...
                    if step == 0:
                        ...
                        mixed_target[step] = (1-beta) * self.value_preds[step] + (beta)*mixed_target[step-1]
                        delta[step] = self.rewards[step] + gamma * ((1-beta)*self.value_preds[step + 1]+beta * mixed_target[step-1]) * self.masks[step + 1] - self.value_preds[step]
    ...
    def feed_forward_generator(self,
        ...
        for indices in sampler:
            ...
            value_preds_batch = self.value_mixed[1:].view(-1, 1)[indices]
            ...
            yield obs_batch, recurrent_hidden_states_batch, actions_batch, \
                value_preds_batch, return_batch, masks_batch, old_action_log_probs_batch, adv_targ,indices
