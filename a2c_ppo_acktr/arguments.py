...
def get_args():
    ...
    parser.add_argument('--N-recurrent',
        type=int,
        default=0,
                        )
    ...
    parser.add_argument('--beta-reg',
         type=float,
         default=0,
                        )
    parser.add_argument('--learned-beta-reg',
        type=int,
        default=0,
                        )
    parser.add_argument('--init-beta',
        type=float,
        default=0
                        )
    parser.add_argument('--non-linear-value',
        type=int,
        default=0,
        )
    ...
    parser.add_argument('--log-comet',
        type=int,
        default=0,
                        )
    parser.add_argument('--fixed-beta',
        type=float,
        default=1
        )
